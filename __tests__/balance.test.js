...
describe('balance api', () => {
  ...
  it('should return 200 with a valid body', async () => {
    ...
    // XXX
    // The old method to calculate balance used to add all outputs that were unspent (spent_by === null) and unlocked
    // The current method to process balance adds the outputs and removes the balance from any inputs of our wallets
    // But since the fixture has an input of our wallet that is not in any other tx the balance is removed from the sum of the outputs
